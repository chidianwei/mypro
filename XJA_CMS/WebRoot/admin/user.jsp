			...
			<DIV class="column">
				...
				<table id="MyDataList" cellspacing="1" cellpadding="1"
					...
					<TR class="tdbg" onMouseOver="this.className='tdbg-dark';"  id="tr<s:property value="id"/>"
						...
						<TD align="center">
							<INPUT name="ids" type="checkbox" value="<s:property value="id"/>" show="<s:property value="loginname"/>"/>
						<input type="hidden" id="loginnamevalue<s:property value="id"/>" value="<s:property value="loginname"/>"/>
						</TD>
