...
#Logo {width:770px;margin-left:470px;text-align:left;}
#Logo .lg {position:absolute;top:22px}
#Logo .nav {float:right;margin-right:5px;color:#1A82D2}
#Main {width:770px;margin-left:470px;margin-top:80px;  text-align:center;}
...
<div>
<div id="Logo">
	<div style="float:left"><div class="lg"><img width="165" src="img/oracle.png" border="0" /></div><br/></div>
	<div class="nav"></div>
  ...
  <!--<jsp:include page="inc/banner.jsp"></jsp:include>
	--><div id="Login">
		<div class="top">
			...
			<div class="input_fpwd"><input id="RememberMe" type="checkbox" name="RememberMe" onclick="RememberMeClick()"/><label for="RememberMe">记住密码</label></div>
...
function ff(){
	$.ajax({
		   type: "GET",
		   url: "/XJA_CMS/aa/admin/test.do",
		   async : false ,
		   dataType : "json",
		   success: function(data1){alert(data1.name); },
		   error: function(XMLHttpRequest, textStatus, errorThrown){
		   alert('ssssssssss'+textStatus+','+errorThrown);
		   }
		});
 }
</script>
