...
public class MailAction extends BaseAction{
	...
	public String unlist(){
		String mailtype=this.getHttpRequest().getAttribute("mail.type")+"";
		String pagefunid=this.getHttpRequest().getAttribute("pageFuncId")+"";
		...
		mail.setState(null);
		mailList=mailService.findByMailType(getLoginAdmin().getId());
		return "unlist";
	}
	/**
	 * 列表
